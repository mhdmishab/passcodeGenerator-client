...
function Home() {
  ...
  return (
    <div className="mb-16">
      <div className="flex flex-col md:flex-row ">
        <div className="flex-1  md:w-1/2">
          <img src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.flaticon.com%2Ffree-icon%2Fpassword_3176384&psig=AOvVaw2CqPwtjR37EobxXeHSajNc&ust=1693332436078000&source=images&cd=vfe&opi=89978449&ved=0CBAQjRxqFwoTCKiYsIT5_4ADFQAAAAAdAAAAABAJ" alt="Image" className="h-full w-full object-cover" />
        </div>
        <div className="flex-1  p-10 flex flex-col justify-center items-center md:items-start md:w-1/2">
          <div className="mb-8 text-center md:text-left">
            <h1 className="text-4xl font-semibold font-serif mb-4 text-white">
            PassCode Generator: Generating Super Strong Passwords Just For You
            </h1>
    ...
    {userToken?<><h1 className="text-4xl font-semibold mb-4 ml-10 font-serif text-white ">Saved Password</h1>
    <div>
      <div className="flex flex-wrap">
        {savedPasswordData.map((data: any, index: number) => (
          <Card
            key={index}
            image={<img src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.flaticon.com%2Ffree-icon%2Fpassword_421648&psig=AOvVaw2CqPwtjR37EobxXeHSajNc&ust=1693332436078000&source=images&cd=vfe&opi=89978449&ved=0CBAQjRxqFwoTCKiYsIT5_4ADFQAAAAAdAAAAABAE" alt="Card Image" className="rounded-full h-16 w-16" />}
            head={data.appName}
